"""
Django settings for Essential_Glam_Web project.
...
ROOT_URLCONF = 'Essential_Glam_Web.urls'
...
WSGI_APPLICATION = 'Essential_Glam_Web.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'Essential_Glams/static'),
)
